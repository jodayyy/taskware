				...
				<div class="p-2">
					...
					@else
						...
						<div class="text-center py-12">
							...
							<h3 class="text-lg font-medium text-primary mb-2">No active projects</h3>
							<p class="text-primary mb-4">Create a project and add tasks to see progress!</p>
							<a 
								href="{{ session('is_guest') ? route('guest.projects.create') : route('projects.create') }}"
				...
				<div class="p-2">
					...
					@else
						...
						<div class="text-center py-12">
							...
							<h3 class="text-lg font-medium text-primary mb-2">No upcoming deadlines</h3>
							<p class="text-primary mb-4">Tasks with deadlines in the next 7 days will appear here.</p>
						</div>
					@endif
				</div>
			</div>
